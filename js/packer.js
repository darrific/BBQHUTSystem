var template = '{{#OrderCount}}<div class="row padding_20 bg_5 w"><div class="row"><div class="col-lg-7 col-lg-offset-1"><div class="row"><div class="col-lg-2"><h2>ID: {{id}}</h2></div><div class="col-lg-3"><h3>Name: {{consumerName}}</h3></div><div class="col-lg-3"><h3>Ph#: {{phoneNumber}}</h3></div></div><div class="container bg_4"><h4>Breakdown:</h4>{{#items}}<div class="row"><div class="col-lg-1 col-lg-offset-1"><h4>{{quantity}}</h4></div><div class="col-lg-2"><h4>{{name}}</h4></div><div class="col-lg-2"><h4>${{price}}.00</h4></div><div class="col-lg-2"><a href="#"><button id="printButton" class="btn btn-info btn-block"><h4>Print</h4></button></a></div></div><br>{{/items}}</div></div><br><br><br><br><br><br><br><br><div class="col-lg-4"><div class="col-lg-6 col-lg-offset-3"><a href="#"><button class="btn btn-success btn-block"><h3>Packed</h3></button></a></div></div></div><br><div class="row"><div class="col-lg-3 col-lg-offset-1"><h2 class="padding_10"><b>Pickup: </b>{{pickup}}</h2></div><div class="col-lg-3"><h2 class="padding_10"><b>Status: </b>{{status}}</h2></div></div></div>{{/OrderCount}}';
var order = [];
